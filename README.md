...
<p>
  ...
  <code>Bioengineering</code> ·
  <code>Medical Imaging</code> ·
  <code>Medicine</code>
</p>

<p>
  <a href="https://scholar.google.com/citations?hl=es&user=f5BiZdcAAAAJ">Google Scholar</a>
  &nbsp;·&nbsp;
  <a href="https://orcid.org/0009-0005-3096-266X">ORCID</a>
  &nbsp;·&nbsp;
  <a href="https://www.linkedin.com/in/betsaida-lariza-lopez-covarrubias-782622296">LinkedIn</a>
  &nbsp;·&nbsp;
  <a href="https://www.researchgate.net/profile/Betsaida-Lariza-Covarrubias">ResearchGate</a>
  &nbsp;·&nbsp;
  <a href="mailto:lariza.lopez@uabc.edu.mx">Email</a>
</p>
...
- **2026–Present · Doctoral Program in Science**
  - Master's and Doctoral Program in Science and Engineering, UABC
  - *Mobile and Ubiquitous Computing research line*

- **2024–2026 · Master of Engineering with Honors**
  - Master's and Doctoral Program in Science and Engineering, UABC
  - *Mobile and Ubiquitous Computing research line*

- **2019–2022 · Bachelor's Degree in Bioengineering with Honors**
  - Universidad Autónoma de Baja California

### 🏛️ Research groups and academic involvement

- **Telematics Laboratory**
  - Graduate student participating in research activities
  - Faculty of Engineering, Architecture and Design, UABC

- **Computational Medicine Group**
  - Graduate student collaborator
  - Faculty of Health Sciences, UABC
...
![Digital Fundus Imaging](https://img.shields.io/badge/Digital%20Fundus%20Imaging-6A11CB?style=flat-square)
![Diabetic Retinopathy](https://img.shields.io/badge/Diabetic%20Retinopathy-7B2CBF?style=flat-square)
![Image Segmentation](https://img.shields.io/badge/Image%20Segmentation-4361EE?style=flat-square)
![Clinical Evaluation](https://img.shields.io/badge/Clinical%20Evaluation-4895EF?style=flat-square)

</div>

> Development and evaluation of artificial intelligence methods for identifying and segmenting pathological regions associated with **diabetic retinopathy** in digital fundus images.
...
- Hybrid convolutional and attention-based architectures
- U-Net and U-Net++ models
- Quantitative and qualitative evaluation
- Clinical assessment by specialists
...
![Volumetric Medical Imaging](https://img.shields.io/badge/Volumetric%20Medical%20Imaging-3A0CA3?style=flat-square)
![Generative Models](https://img.shields.io/badge/Generative%20Models-6A11CB?style=flat-square)
![Reconstruction](https://img.shields.io/badge/Reconstruction-2575FC?style=flat-square)
![Super--resolution](https://img.shields.io/badge/Super--resolution-4895EF?style=flat-square)

</div>

> Development and evaluation of computational methods for **volumetric medical image analysis**, particularly for reconstruction and super-resolution tasks.
...
- Generative computational approaches
...
I enjoy participating in interdisciplinary collaborations between engineering and medicine, mentoring girls and young women interested in STEM, communicating scientific knowledge, and exploring technologies that may improve access to specialized healthcare.
